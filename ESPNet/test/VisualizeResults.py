...
def main(args):
    ...
    if args.modelType == 2:
        ...
        model_weight_file = args.weightsDir + os.sep + 'encoder' + os.sep  + 'model_300.pth'
        ...
        model_weight_file = args.weightsDir + os.sep + 'decoder' + os.sep  + 'model_300.pth'
        if not os.path.isfile(model_weight_file):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', default="./data_road", help='Data directory')
    ...
    parser.add_argument('--inHeight', type=int, default=480, help='Height of RGB image')
    ...
    parser.add_argument('--weightsDir', default='./weights/', help='Pretrained weights directory.')
